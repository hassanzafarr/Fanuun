...
const Services = () => (
  <div className="services__expect-main">
    ...
    <div className="services__possiblity-main">
      <div className="services__possibility section__padding " id="possibility">
          ...
          <div className="ser__section-logo-container">
            ...
            <div className="ser-container-a">
              <div className="ser-sub-cont">
                ...
                <p>
                  The Fanuun team offers investment-based immigration options
                  that may lead to one of the best countries to live
                  permanently, along with thorough assistance and expert advice
                  for all facets of the move, from developing a customized Case
                  Map and gathering all supporting evidence to submitting an
                  application.
                </p>
              </div>
            </div>
      ...
      <div className="service-main">
        ...
        <div
          className="services__possibility section__padding  "
          id="possibility"
        >
          <div className="services__possibility-content">
            <Fade left>
              ...
              <p>
                ...
                consulting firm, and are known as "The Enabler" in the industry.
